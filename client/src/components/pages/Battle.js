        ...
        <div className='bg-blue-800 border-8 p-auto'>
            ...
            <div className='grid grid-cols-2 mb-8'>
                <div>
                    ...
                    <p className='text-3xl mb-4 text-teal-200 text-center p-1'>You have {characterHP} HP.</p>
                ...
                <div>
                    ...
                    <p className='text-3xl mb-4 text-teal-200 text-center p-1'>The enemy has {enemyHP} HP.</p>
